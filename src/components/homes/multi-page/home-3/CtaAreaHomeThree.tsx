...
const cta_content: DataType = {
  title: <>Access a wide range of  <br /> IT solutions and services with ease.</>,
  btn_text: "Know More",
}
...
const CtaAreaHomeThree = () => {
  return (
    <>
      <section className="cta-area tp-cta-two pt-120 pb-120 mt-40">
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="tp-cta-two-wrapper text-center">
                ...
                <div className="tp-cta-two-btn wow fadeInUp" data-wow-duration="1s" data-wow-delay=".7s">
