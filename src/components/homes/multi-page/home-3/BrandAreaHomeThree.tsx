...
const BrandAreaHomeThree = ({style, style_2} : any) => {
  ...
  return (
    <div ref={ref}> 
      <div className={inView? `zoom-ins brand-area ${style? "pt-120 pt-sm-fourty" : style_2 ? "pt-110" : ""} pb-110`:`zoom-outs brand-area ${style? "pt-120 pt-sm-fourty" : style_2 ? "pt-110" : ""} pb-110`}>
