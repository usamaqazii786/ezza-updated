...
const {sub_title, title} = about_content
const AboutTeamArea = () => {
  const team_members = team_data.filter((menubar => menubar.page === 'home_3'))
  return (
    <>
      {/* <section className="team-area fix pb-60">
        <div className="container">
          ...
          <div className="row">
            {team_members.slice(0, 3).map((item, i) =>
              <div key={i} className="col-lg-4 col-md-6 col-sm-6">
                <div className="tp-team-3-item mb-40">
                  ...
                  <div className="tp-team-3-content">
                    <h5 className="tp-team-3-title"><Link href="/team-details">{item.name}</Link></h5>
