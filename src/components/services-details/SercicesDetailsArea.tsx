  ...
  service_list: [
    {
      id: 1,
      title: "Cloud Service",
      description: "Cloud Service description goes here...",
      image: services_details_thumb_1,
    },
    {
      id: 2,
      title: "Web Development",
      description: "Web Development description goes here...",
      image: services_details_thumb_1,
    },
    {
      id: 3,
      title: "UI/UX Designing",
      description: "UI/UX Designing description goes here...",
      image: services_details_thumb_1,
    },
    {
      id: 4,
      title: "IT Management",
      description: "IT Management description goes here...",
      image: services_details_thumb_1,
    },
    {
      id: 5,
      title: "Data Visualization",
      description: "Data Visualization description goes here...",
      image: services_details_thumb_1,
    },
    {
      id: 6,
      title: "Security System",
      description: "Security System description goes here...",
      image: services_details_thumb_1,
    },
  ],
  contact_info: [
...
const SercicesDetailsArea = () => {
  const [activeService, setActiveService] = useState(services_content.service_list[0]);
  return (
    <>
          ...
          <div className="row">
              ...
              <div className="tp-services-details-wrap mb-40">
                <div className="tp-services-details-services mb-50">
                  ...
                  <div className="tp-services-details-services-wrap">
                    {services_content.service_list.map((list) => (
                      <Link
                        key={list.id}
                        href="#"
                        className={`block w-full text-left py-2 px-4 border-b cursor-pointer ${activeService.id === list.id ? 'bg-[#FFD700]' : 'bg-gray-100'
                          }`}
                        onClick={(event) => {
                          event.preventDefault(); // 🔄 Page Reload रोकने के लिए 
                          setActiveService(list); // ✅ State Update
                        }}
                      >
                        {list.title} {/* ✅ Display only the title */}
            ...
            <div className="col-lg-8">
              <div className="tp-services-details-wrapper ml-30">
                ...
                <h4 className="tp-services-details-title mb-20">{activeService.title}</h4>
                ...
                <h4 className="tp-services-details-title">{activeService.title}</h4>
                <p>{activeService.description}</p>
